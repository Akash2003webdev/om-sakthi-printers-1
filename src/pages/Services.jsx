...
const FULL_SERVICES = [
  {
    ...
    image:
      "https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQpo0WNONFWSn-YGp0eHh-L4Z5szNI2k00yvowq10_CFGGqh8ja70PAyRnZ6ezU5GGu9kvelfVe7Pl6sdNKROIdy3D4eOGnmaoarRiWx3fFa9ojSqSm4uE1xQ",
    popular: true,
  },
  {
    id: "visiting",
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcT3-8DModzmNqg1Cd59RHP86dB2cv-yaldQTE8iHUWfF_XxTEtCD10tMQoiL8kt3GjNnfkRs1Xs1SmvmW3nA_9mlqlKHTWF2InWeVV3Ppo",
    popular: false,
  },
  {
    id: "banner",
    ...
    image:
      "https://karkitechs.com/wp-content/uploads/2025/05/karkitechs.com_wedding_flex_1.webp",
    popular: false,
  },
  {
    id: "custom",
    ...
    image:
      "https://5.imimg.com/data5/SELLER/Default/2026/1/579227283/BU/MJ/HK/215787450/offset-printing-service.png",
    popular: false,
  },
];
    ...
    <main className="section-bg min-h-screen">
      ...
      >
        ...
        >
          ...
          >
            From wedding invitations to corporate materials — premium printing
      ...
      <section className="container-xl section-pad" ref={cardsRef}>
        <div className="flex flex-col gap-24">
          {FULL_SERVICES.map((svc, i) => (
            <div
              key={svc.id}
              className={`service-card grid grid-cols-1 md:grid-cols-2 gap-12 items-center`}
            >
              <div
                className={`relative overflow-hidden aspect-[4/3] ${i % 2 === 1 ? "md:order-2" : ""}`}
              >
                <img
                  src={svc.image}
                  alt={svc.title}
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top right, rgba(0,0,0,0.3), transparent)",
                  }}
                />
                {svc.popular && (
                  <div
                    className="absolute top-4 left-4 px-3 py-1.5 text-xs tracking-widest uppercase font-body font-semibold"
                    style={{
                      background: "rgba(201,136,16,0.9)",
                      color: "#0a0705",
                    }}
                  >
                    Most Popular
                ...
                <div
                  ...
                  style={{
                    borderRight: "1px solid rgba(201,136,16,0.3)",
                    borderBottom: "1px solid rgba(201,136,16,0.3)",
                  }}
                />
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-8">
                  {svc.features.map((f, fi) => (
                    <div key={fi} className="flex items-center gap-2.5">
                      <CheckCircle
                        size={13}
                        style={{ color: "rgba(201,136,16,0.7)" }}
                        className="shrink-0"
                      />
                      <span
            ...
            {[
              {
                num: "01",
                title: "Choose Design",
                desc: "Browse our gallery or describe your vision",
              },
              {
                num: "02",
                title: "Customise",
                desc: "Share names, date, and any changes needed",
              },
              {
                num: "03",
                title: "Approve Proof",
                desc: "We send a digital preview for your approval",
              },
              {
                num: "04",
                title: "Print & Deliver",
                desc: "High-quality prints delivered to your door",
              },
            ].map((step, i) => (
              <div key={i} className="text-center relative">
                {i < 3 && (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, rgba(201,136,16,0.3), transparent)",
                    }}
                  />
                )}
                <div
